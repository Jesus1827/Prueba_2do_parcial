// URLs de la API
const API_BASE_URL = "https://proyectosis414-g-7bitssinexito.onrender.com";
const API_OFICINAS = `${API_BASE_URL}/api/oficinas`;
const API_ESTADOS = "https://cta-par-adrianasullcacolque-g2.onrender.com/api/estados";
